    ...
    $.fn.easyPaginate = function (options) {
        ...
        return this.each(function (instance) {
            ...
            var displayNav = function () {
                htmlNav = '<div class="easyPaginateNav"><div div class="row"><div class="col-md-12" style="margin-top: 10px;"><ul class=" pagination justify-content-center">';
